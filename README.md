...
## Overview
This is simple and Quick tool for setting up your gdrive on terminal.

## How to get started
### Start with cloning repo.
```
git clone https://github.com/noobyysauraj/gdsetup.git
```
...
## What if you want to reset your setup.
